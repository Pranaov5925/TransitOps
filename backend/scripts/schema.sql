...
CREATE TABLE IF NOT EXISTS vehicles (
  ...
  permitType  VARCHAR(20)  NOT NULL DEFAULT 'National',
  fastagBalance DOUBLE       NOT NULL DEFAULT 5000,
  pucExpiry   VARCHAR(20)  NOT NULL DEFAULT '2027-07-12',
  fcExpiry    VARCHAR(20)  NOT NULL DEFAULT '2027-07-12',
  createdAt   TIMESTAMP    DEFAULT CURRENT_TIMESTAMP,
  updatedAt   TIMESTAMP    DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS trips (
  ...
  estimatedTollCost DOUBLE      NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS fuel_logs (
  ...
  pilferageAlert VARCHAR(255) NULL,
  createdAt TIMESTAMP    DEFAULT CURRENT_TIMESTAMP,
  updatedAt TIMESTAMP    DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  FOREIGN KEY (vehicleId) REFERENCES vehicles(id),
